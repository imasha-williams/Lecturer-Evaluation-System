...
if (isset($_POST['Change_LecturerPassword'])) { 
    ...
    if ($oldpass==$_POST['l_pass']) {
        $sql = "UPDATE `user` SET `password`= '".$_POST['l_new'] ."' WHERE email ='".$_SESSION['email']."'";
        $conn->query($sql);
        ...
        <div class="card">
            ...
            <h5 class="card-title">Change Your Password</h5>
                <div class="row mb-3">
                    ...
                    <input type="password" class="form-control" onkeyup='check_pass();' id="l_pass" name="l_pass" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                    <input type="password" class="form-control" id="LecturerPassword" name="l_new">
                    </div>
                </div>

                <div class="col-sm-10">
                  <button type="submit" class="btn btn-primary" name="Change_LecturerPassword">Submit</button>
                </div>
