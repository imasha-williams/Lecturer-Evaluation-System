    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-11">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Adding a New Student</h5>

              <!-- General Form Elements -->
              <form action="Controller/Manage_Student.php" method="POST">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="tele" class="form-control"  name = "phone" required>
                  </div>
                </div>
