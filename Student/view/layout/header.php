...
switch ($active) {
	...
	case "Change_StudentPassword":
	  $Change_StudentPassword="active";
		$active="Change_StudentPassword";
		break;
}
...
<head>
  ...
  <title>Student Panel - $active</title>
	...
	<header id="header" class="header fixed-top d-flex align-items-center">
		...
		<div class="d-flex align-items-center justify-content-between">
		  <a href="Dashboard.php" class="logo d-flex align-items-center">
			...
			<span class="d-none d-lg-block">Student Panel</span>
		  </a>
  ...
  <aside id="sidebar" class="sidebar">
	...
	<ul class="sidebar-nav" id="sidebar-nav">
	  ...
	  <li class="nav-item"> $Question
		<a class="nav-link collapsed" href="Lecturer_View.php">
	  ...
	  <li class="nav-item">
		<a class="nav-link collapsed $Change_StudentPassword" href="Change_Password.php">
